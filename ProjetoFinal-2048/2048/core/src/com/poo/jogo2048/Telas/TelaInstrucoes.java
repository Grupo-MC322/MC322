...
public class TelaInstrucoes extends TelaAbstrata
{
    ...
    public void criaStage()
    {
        ...
        // fundo
        if(pagina == 1)
            txtrFundo = new Texture(Gdx.files.internal("telas/fundo_instrucoes_1:4.png"));
        else if(pagina == 2)
            txtrFundo = new Texture(Gdx.files.internal("telas/fundo_instrucoes_2:4.png"));
        else if(pagina == 3)
            txtrFundo = new Texture(Gdx.files.internal("telas/fundo_instrucoes_3:4.png"));
        else if(pagina == 4)
            txtrFundo = new Texture(Gdx.files.internal("telas/fundo_instrucoes_4:4.png"));
        ...
        Texture txtrBotaoProx = new Texture(Gdx.files.internal("botoes/botao_proximo.png"));
        ...
        Texture txtrBotaoAnt = new Texture(Gdx.files.internal("botoes/botao_anterior.png"));
